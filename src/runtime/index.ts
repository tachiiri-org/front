...
import { isComponent, isListComponent, type Component } from '../schema/component';
import { renderComponent } from './render/page/component';
import type { FrameState } from '../state';
import { hydrateEditor } from './bind/index';
import { store, domMap } from '../state';

export { renderComponent, hydrateEditor, store, domMap };
...
export type { Screen, Frame, Component, FrameState };
