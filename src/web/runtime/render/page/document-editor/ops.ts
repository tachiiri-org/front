...
export const dispatchNodeFocus = (documentEditorFrameId: string, nodeId: string, nodeText: string): void => {
  document.dispatchEvent(new CustomEvent('document-editor:node-focus', {
    detail: { documentEditorFrameId, nodeId, nodeText },
  }));
};

export const dispatchNodeTextChange = (documentEditorFrameId: string, nodeId: string, nodeText: string): void => {
