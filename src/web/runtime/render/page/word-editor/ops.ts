...
export const dispatchNodeFocus = (wordEditorFrameId: string, nodeId: string, nodeText: string): void => {
  document.dispatchEvent(new CustomEvent('word-editor:node-focus', {
    detail: { wordEditorFrameId, nodeId, nodeText },
  }));
};

export const dispatchNodeTextChange = (wordEditorFrameId: string, nodeId: string, nodeText: string): void => {
  document.dispatchEvent(new CustomEvent('word-editor:node-text-change', {
    detail: { wordEditorFrameId, nodeId, nodeText },
  }));
};
