...
export const renderWordEditor = (
  ...
  document.addEventListener('definition-editor:closed', (e: Event) => {
  ...
  document.addEventListener('definition-editor:move-to-word', (e: Event) => {
