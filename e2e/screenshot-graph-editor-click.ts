...
fs.writeFileSync('/tmp/graph-editor-clicked.png', Buffer.from(data, 'base64'));
...
console.log('columns:', colCount, '| col1 nodes:', col1Count);
console.log('saved /tmp/graph-editor-clicked.png');
await b.close();
